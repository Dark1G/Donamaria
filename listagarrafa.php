...
<body>
	...
	<main class="container">
        <h1 class="titemp">Garrafas</h1>
        <p class="lead subtit">A nossa lista de garrafas.</p>
        ...
        <?php
            if (!isset($model) || !isset($controller) || !isset($view))
            {
                ...
                $data = $view->listaGarrafeiraClientes();
				$garrafeira = $data[1];
				include($data[0]);
            }
            require_once('views/garrafeira/indexclient.inc.php');
        ?>
        <hr class="linha">
        <hr>
	</main>
